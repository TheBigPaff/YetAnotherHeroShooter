...
public class PVPGame : NetworkBehaviour
{
    [Header("UI Settings")]
    public TMP_Text gameTimerTitle;
    ...
    public static PVPGame Singleton { get; private set; }
    ...
    public override void NetworkStart()
    {
        if (IsClient && !IsServer)
        {
            ...
            hasGameStarted.OnValueChanged += (oldValue, newValue) =>
            {
                ...
                gameTimerTitle.gameObject.SetActive(!m_ClientGameStarted);
    ...
    private void OnGameStarted()
    {
        ...
        gameTimerTitle.gameObject.SetActive(false);
        //CreateAliens();
        //CreateShields();
        //CreateSaucer();
    }
